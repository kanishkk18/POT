...
const MacbookScroll = ({
  ...
  const scaleY = useTransform(scrollYProgress, [0, 0.1], [0.6, isMobile ? 1 : 1.5]);
  ...
  return (
    (<div
      ref={ref}
      className="min-h-[305vh] flex flex-col items-center py-0 md:py-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50">
     ...
     <motion.h2
      ...
      >
        {title || (
          <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b bg-clip-text text-center text-5xl font-semibold leading-none text-transparent from-white to-slate-900/10">
            Your backbone to Crypto scams <br/>and unlimited income
          </span>
        )}
      </motion.h2>
      {/* Lid */}
      ...
      {/* Base area */}
      <div
        className="h-[22rem] w-[32rem] bg-[#242324] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        ...
        {showGradient && (
          <div
            className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t from-black via-black to-transparent z-50"></div>
        )}
  ...
  return (
    (<div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-[#080808f3] rounded-2xl p-2 relative">
        <div
          style={{
            boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
          }}
          className="absolute inset-0 bg-[#0a0a0ada] rounded-lg flex items-center justify-center">
          <span className="">
           <img className="h-[10.8rem] w-[31rem] rounded-[5px]" src="https://i.pinimg.com/564x/84/53/85/84538557202f6d1f29cbffc041b48327.jpg" alt="" />
          </span>
        </div>
      </div>
      <motion.div
        ...
        <div className="h-full w-full">
          <img className="object-cover object-left-top absolute rounded-lg inset-0 min-h-full w-full" src="https://res.cloudinary.com/dna3hwzre/image/upload/v1739825383/POT/gm5bkpncxkm6ipfwhwnr.webp" alt="" />
        {/* <HeroVideoDialog
        animationStyle="from-bottom"
        videoSrc="https://www.youtube.com/embed/wQJagH3iJkI?si=naWbhbemn7gklrHe"
        thumbnailSrc="https://res.cloudinary.com/dna3hwzre/image/upload/v1739825383/POT/gm5bkpncxkm6ipfwhwnr.webp"
        thumbnailAlt="Hero Video"
          className="object-fill object-left-top absolute rounded-lg inset-0 min-h-[100%] w-full" /> */}
          </div> 
      </motion.div>
    </div>)
  );
...
export const KBtn = ({
  ...
  return (
    (<div
      className={cn(
        "p-[0.5px] rounded-[4px]",
        backlit && "bg-white/[0.2] shadow-xl shadow-white/30"
      )}>
      <div
        className={cn(
...
export const SpeakerGrid = () => {
  return (
    (<div
      className="flex px-[1px] gap-[1px] mt-2 h-40"
      style={{
        backgroundImage:

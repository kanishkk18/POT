      ...
      <>
        ...
        >
          ...
          >
            <motion.div
              style={{
                ...
                transformOrigin: useTransform(() => {
                  if (sliderRef.current) {
                    const { left, width } = sliderRef.current.getBoundingClientRect();
                    return clientX.get() < left + width / 1 ? "right" : "left";
                  }
                }),
            ...
            >
              <div className="relative h-full flex-grow overflow-hidden rounded-full bg-white dark:bg-white">
                <div
                  className="absolute h-full bg-yellow-400 dark:bg-[#2647eb] rounded-full"

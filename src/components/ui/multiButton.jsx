...
export function FamilyButtonDemo() {
  return (
      ...
      <div className="px-3 py-2 flex items-center justify-between border-b border-gray-800/50">
        <div className="flex items-center gap-2">
          <div className="relative">
            <img
              src="https://i.pinimg.com/736x/d4/aa/30/d4aa30301476fddc5d07d45e1a2002e2.jpg"
              alt="Profile"
              
              className="rounded-full h-32 w-32"
            />
            <div className="absolute bottom-0 right-0 w-2 h-2 bg-green-500 rounded-full border border-[#1a1b2e]"></div>
          </div>
          <div>
            <h2 className="text-white text-sm font-medium">Lorant One</h2>
      ...
      {/* Chat Area */}
      <div className="flex-1 overflow-y-scroll p-3 space-y-1 thin-scrollbar">
        <div className="flex justify-end">
          <div className="bg-[#3d01c5] text-white rounded-2xl py-2 px-3 max-w-[80%] text-sm">
            yo brother, how's it going?
          </div>
        </div>

        <div className="flex justify-start">
          <div className="bg-transparent border border-neutral-600 text-white rounded-2xl rounded-bl-sm py-2 px-3 max-w-[80%] text-sm">
            Good good
          </div>
        </div>

        <div className="flex justify-start">
          <div className="bg-transparent border border-neutral-600 text-white rounded-2xl rounded-l-sm py-2 px-3 max-w-[80%] text-sm">
            playin Overcooked with Zsofia rn
          </div>
        </div>

        <div className="flex justify-start">
          <div className="bg-transparent border border-neutral-600 text-white rounded-2xl rounded-tl-sm py-2 px-3 max-w-[80%] text-sm">
            what about you?
          </div>
        </div>
        ...
        <div className="space-y-1">
          <div className="flex justify-end">
            <div className="bg-[#3d01c5] text-white rounded-2xl py-2 px-3 max-w-[80%] text-sm">
              guess what, I'm in Seoul haha. just caught this amazing sunset, look!
            </div>
          </div>
          <div className="flex justify-end">
            <div className="rounded-lg overflow-hidden">
              <img
                src="https://once-ui.com/_next/image?url=%2Fimages%2Fdemos%2Fsocial_01.jpg&w=256&q=75"
                alt="Sunset in Seoul"
                width={200}
                height={100}
      ...
      {/* Message Input */}
      <div className="p-3">
        <div className="flex items-center gap-2 bg-transparent border border-neutral-600 backdrop-blur-lg rounded-full px-3 py-1.5">
